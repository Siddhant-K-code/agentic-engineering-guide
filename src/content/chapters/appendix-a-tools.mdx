...
#align(center)[#table(
  ...
  [Python],
  [MIT],
  [OpenAI-native agent building],
  [[Goose](https://github.com/block/goose)],
  [Agent],
  [Rust/Python],
  [Apache 2.0],
  [MCP-native production agent],
  [[Mastra](https://github.com/mastra-ai/mastra)],
  [Framework],
  [TypeScript],
  [MIT],
  [TypeScript-first agent building],
)
]
...
#align(center)[#table(
  ...
  [Autonomous],
  [Usage-based],
  [Autonomous end-to-end development, fleet-scale migrations, enterprise
  (VPC)],
...
#align(center)[#table(
  ...
  [[Distill](https://github.com/siddhant-k-code/distill)],
  [Context deduplication and compression],
  [Python],
  [MIT],
  [[AnythingLLM](https://github.com/Mintplex-Labs/anything-llm)],
  [Local RAG and document management],
  [JavaScript],
  [MIT],
  ...
  [Open agent skills ecosystem (reusable SKILL.md files)],
  [TypeScript],
  [MIT],
)
]
